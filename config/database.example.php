<?php
// config/database.example.php - Fichier de configuration exemple
// Copiez ce fichier en database.php et remplissez vos identifiants
...
if ($is_local) {
    ...
    // Configuration Local by Flywheel par défaut
    ...
    define('DB_NAME', 'VOTRE_NOM_DE_BASE'); // À MODIFIER
    define('DB_USER', 'VOTRE_UTILISATEUR'); // À MODIFIER
    define('DB_PASS', 'VOTRE_MOT_DE_PASSE'); // À MODIFIER

    define('APP_URL', 'https://votredomaine.com/'); // À MODIFIER
